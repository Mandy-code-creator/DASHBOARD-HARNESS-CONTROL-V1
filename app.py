    ...
    # ==============================================================================
        ...
        if len(data) < 10: 
            ...
            if len(sub_mech) >= 5:
                ...
                # --- BIỂU ĐỒ PHÂN PHỐI (VẼ 2 ĐƯỜNG NORMAL CURVE CHO CẢ LINE VÀ LAB) ---
