...
# ================================
    ...
    # ================================
        ...
        pred_type = st.radio(
            ...
            ["Single Value", "Range"],
            key="predict_type_unique"  # phải hoàn toàn khác các key khác
        )
        ...
        if pred_type == "Single Value":
            user_hrb = st.number_input(
                ...
                key="predict_hrb_single_unique"  # key mới hoàn toàn
            )
            hrb_values = [user_hrb]
        else:
